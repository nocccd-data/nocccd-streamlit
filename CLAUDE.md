...
Claude Code entrypoint for `/Users/hoonywise/GitHub/nocccd-data/nocccd-streamlit`.

This file is intentionally small and does not import `AGENTS.md`. Do not read `AGENTS.md` unless the user explicitly asks; it is the Codex entrypoint for the same project and exists to avoid cross-tool context duplication.
